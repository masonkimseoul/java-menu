...
public enum Menu {
    ...
    Menu(int categoryIndex, String categoryName, List<String> menus) {
    ...
    public static Menu fromCategoryName(String categoryName) {
        for (Menu menu : Menu.values()) {
            if (menu.getCategoryName().equals(categoryName)) {
                return menu;
            }
        }
        return null;
